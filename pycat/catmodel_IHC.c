/* Time-stamp: <2009-10-06 14:51:17 marek>
...
double C1ChirpFilt(double x, double binwidth,double cf, int n, double taumax, double rsigma)
{
     ...
     if (p[1].x>0.0) {
	  /* mexErrMsgTxt("The system becomes unstable.\n"); */
     ...
     if (rzero>0.0) {
	  /* mexErrMsgTxt("The zeros are in the right-half plane.\n"); */
...
double C2ChirpFilt(double xx, double binwidth,double cf, int n, double taumax, double fcohc)
{
     ...
     if (rzero>0.0) {
	  /* mexErrMsgTxt("The zeros are in the right-hand plane.\n"); */
